...
export const GOLD_SELECTION_PLANS: PlanItem[] = [
  ...
  },
  {
    ...
    features: [
      ...
      '地方北海道（�export const GENERAL_PLANS: PlanItem[] = [
  {
    id: 'corp_interview',
    name: '1. インタビュー動画撮影',
    price: 150000,
  ...
  },
  {
    ...
    features: [
      ...
      'ホームページや冊子デザイン of 比率（ヨコ・タテ・正方形）を意識したフレーミング',
...
export const GENERAL_PLANS: PlanItem[] = [
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1492691527719-9d1e07e534b4?auto=format&fit=crop&w=800&q=85'
  },
  {
    id: 'corp_pv_short',
    name: '2. 企業PV（2分未満）',
    ...
    recommended: true,
    imageUrl: 'https://images.unsplash.com/photo-1579165466541-71e24690a34a?auto=format&fit=crop&w=800&q=85'
  },
  {
    id: 'corp_pv_long',
    name: '3. 企業PV（5分未満）',
