...
export const About: React.FC = () => {
  return (
    <section id="about" className="py-32 bg-wood-50 relative overflow-hidden">
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col md:flex-row items-center gap-16">
          ...
          >
            <h3 className="text-wood-500 font-bold tracking-[0.3em] text-xs uppercase mb-6">PHILOSOPHY</h3>
            <h2 className="text-4xl md:text-5xl font-serif font-bold text-wood-900 mb-10 leading-loose">
              企業の<span className="text-wood-600">「温度」</span>を<br />
              デザインする。
            </h2>
            <p className="text-wood-700 leading-loose mb-8 font-light tracking-wide text-sm md:text-base">
              美しい映像を作るだけが私たちの仕事ではありません。
              Film Kは、クライアントへのヒアリングを徹底し、
              表面的な魅力だけでなく、その奥にある「想い」や「歴史」を掘り起こします。
            </p>
            <p className="text-wood-700 leading-loose font-light tracking-wide text-sm md:text-base">
