    ...
    <section id="works" className="py-32 bg-wood-50">
      <div className="container mx-auto px-6">
        <div className="flex justify-between items-end mb-16">
          ...
          <div className="hidden md:block text-wood-600 font-medium underline underline-offset-4 decoration-1">
            View All Works
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {works.map((work, index) => (
            <div key={work.id} className="cursor-pointer">
              <motion.div
        ...
        <div className="mt-8 text-center md:hidden">
          <div className="text-wood-600 font-medium underline underline-offset-4 decoration-1">
            View All Works
          </div>
        </div>
      </div>
