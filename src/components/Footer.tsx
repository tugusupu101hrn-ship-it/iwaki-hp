      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-start mb-8">
          <div className="mb-6 md:mb-0 text-center md:text-left">
            <h2 className="text-2xl font-serif font-bold text-white mb-2">合同会社Film K</h2>
            <p className="text-sm text-wood-400 mb-4">企業の真価を映し出す、映像制作カンパニー</p>
            <address className="not-italic text-sm text-wood-400 leading-relaxed">
              代表: 岩城 圭佑<br />
              所在地: 北海道札幌市北区<br />
            </address>
          </div>
